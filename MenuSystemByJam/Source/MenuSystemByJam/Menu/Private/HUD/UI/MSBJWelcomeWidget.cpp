...
#include "Menu/Public/HUD/UI/MSBJWelcomeWidget.h"
#include "MenuSystemByJamGameModeBase.h"

void UMSBJWelcomeWidget::NativeOnInitialized()
{
	check(GetWorld());
	GetWorld()->GetTimerManager().SetTimer(this->TimerWelcomeHandle, this, &UMSBJWelcomeWidget::ResetDelayAnimation, this->DelayTimer, false);
